...
public class StateBaseAI : TankEventHandler
{
    ...
    public BulletPrefabNames bulletName = BulletPrefabNames.NONE;  // 弾の属性設定
    ...
    private void NormalEnemy()
    {
        ...
        bulletName = BulletPrefabNames.RealBullet; // 弾の属性設定
    ...
    private void FastBulletEnemy()
    {
        ...
        bulletName = BulletPrefabNames.HIGHTSPEEDBULLET; // 弾の属性設定
