...
public class TP_Projectile : MonoBehaviour {
	...
	void OnCollisionEnter(Collision collision)
    {
        ...
        {
            //This is to detect if the proyectile collides with the world, patrolPoint used this tag because it is standard in Unity (To prevent asset importing issues)
            DestroyProyectile();
        }
    }
